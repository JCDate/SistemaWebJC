...
<html lang="en" dir="ltr">
  <head>
    ...
    <script src="js/buqInstTroquelados.js"></script>
    <title>I. P. P. T</title>
  ...
  <body>
    ...
    <div class="">
      ...
      <img src='/produccion/img/jcLogo.png' class="izquierda"  width='100' height='100' />
        <h1 align = "center"> <font face="Bookman Old Style,arial,verdana" style="text-shadow: 0.1em 0.1em 0.15em " SIZE="7">INSTALACION Y PUESTA A PUNTO DE TROQUELADOS</font></h1>
    </div><br>
    <div align="center">
