<?php
  ...
  $queryD = "SELECT * FROM descripcion1pc WHERE componente='$componente' AND noPartesP='0010'";
  ...
  AND descripcion3pc.componente='$componente' AND descripcion3pc.noPartesP='0010' AND descripcion3pc.no= descripcion2pc.no";
  $resultD2 = $conexion -> query($queryD2);

  // Se obtiene el máximo no. de actividades que tiene el proceso
  $queryD3 = "SELECT MAX(no) AS res FROM descripcion2pc WHERE componente='$componente' AND noPartesP='0010'";
...
<html lang="es" dir="ltr"> <!-- Se indica el idioma y el tipo de lectura (de izquierda a derecha) -->
  <head>
    ...
    <link rel="stylesheet" href="/produccion/css/botones2.css"> <!-- Se integra el archivo CSS con el diseño de los botones -->
        ...
        <div class="descripcion1" align="center">
          ...
          <fieldset style="width:65%; border-color: #000000; color: #000000; background-color: #C0C0C0;" align="left">
            <legend><label>NÚM. PARTE/ PROCESO</label>
              <input type="text" name="parte10" id="parte10" value="0010" style="width : 30px;" readonly>
            </legend>
            ...
            <div align='right'>
              <fieldset style="width:35%; background-color: #58A1FF; border-color: #000000;">
                <button class="boton_7" type='submit' onclick="this.form.action='borrarActPC.php';this.form.submit();">BORRAR ACTIVIDAD</button><br><br>
