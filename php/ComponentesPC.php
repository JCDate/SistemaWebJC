    ...
    <form id='frm' action="" method="post">
        <?php  if($result -> num_rows > 0) {?>
                ...
                <tr>
                  ...
                  <th bgcolor='#85C1E9' style=" font-size: 15pt;">ACCIÓN</th>
        ...
        <?php   while ($fila = $result  -> fetch_assoc()){ ?>
                    ...
                    <?php if ($fila['familia'] != "0" AND $fila['planC'] == FALSE) { ?>
                        <button type='submit' style='background-color:#AED6F1; border-color:#AED6F1;  border: 0;' class='btn btn-info btn_add'   onclick="this.form.action='php/GenerarPC.php';this.form.submit();" > <img src='img/agregar.png' width='40' height='40' class='zoom'/></button>
                    <?php }else if ($fila['planC'] == TRUE) { ?>
                          <button type='submit' style='background-color:#AED6F1; border-color:#AED6F1; border:0;' class='btn btn-info btn_add' onclick="this.form.action='php/GenerarPCM.php';this.form.submit();"><img src='img/edit.png' width='50' height='50' class='zoom'></button>
                    <?php }else{?>
                        <label>N/A</label>
                    <?php } ?>
                      </td>
