              ...
              <div >
                ...
                <br>
                  ...
                  <div align='center'>
                    ...
                    <?php $queryT = "SELECT totalProceso FROM iniciopc WHERE totalProceso ='0030' AND componente='$componente'";
                            ...
                            <?php }else { ?>
                                    <button type='submit'  class='boton_1'  onclick="this.form.action='GenerarPC0040.php';this.form.submit();"><img src='/produccion/img/guardar.png' width='20' height='20' />SIGUIENTE</button>
                          <?php   } ?>
                  </div>
                <br><br><br>
          </form>
