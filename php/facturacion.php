<?php
  ...
  $query3="SELECT orden,componente,troquel,pieza,pu,contacto,fechaHoraEnvi from facturacionherramental WHERE factura IS NULL ORDER BY componente ASC, orden ASC";
...
<html lang="en" dir="ltr">
  <head>
    ...
    $("#generar2").click(function(){
      ...
      var columns = ["PT", "ORDEN", "COMPONENTE", "TROQUEL", "PIEZA","P. U.($ PESOS)","CONTACTO","ENVIADA"];
      ...
      <?php foreach($facturacionherramental as $c):?>
       ...
       "<?php echo $c->contacto; ?>","<?php echo $c->fechaHoraEnvi; ?>"],
      <?php endforeach; ?>
        ];
        ...
        pdf.autoTable(columns, data, {
            ...
            tableLineWidth: 0,
            columnStyles: {
              0: {columnWidth: 'wrap'}, 1: {columnWidth: 'wrap'}, 2: {columnWidth: 'wrap'}, 3:
              {columnWidth: 'wrap'}, 4: {columnWidth: 'wrap'},
              5: {columnWidth: 'wrap'}, 6: {columnWidth: 'wrap'}, 7: {columnWidth: 'wrap'}
            },
