        ...
        <div class="descripcion1" align="center">
          ...
          <fieldset style="width:65%; border-color: #000000; color: #000000; background-color: #C0C0C0;" align="left">
            <legend>
              ...
              <input type="text" name="parte10" id="parte10" value="0160" style="width : 40px" readonly>
            </legend>
            ...
            <div align='center'>
              ...
              <?php
                $queryT = "SELECT totalProceso FROM iniciopc WHERE totalProceso ='0160' AND componente='$componente'";
                $queryT2 = "SELECT totalProceso FROM iniciopc WHERE totalProceso ='0150' AND componente='$componente'";
                ...
                if ($resultT -> num_rows > 0) { ?>
                  ...
                  <?php } else if ($resultT2 -> num_rows > 0) {
                    $upDate9 = "UPDATE iniciopc SET totalProceso = '0160' WHERE totalProceso ='0150' AND componente='$componente'";
                  ...
                  <button id="boton-siguiente" type="button" class="boton_1" onclick="this.form.action='GenerarPC0170.php';"><img src="/produccion/img/guardar.png" width="20" height="20" />SIGUIENTE</button>
              <?php } ?>
            </div>
          </fieldset>
        </div>
    ...
    <div id="formAddVar" align="center" style="display: none;">
      <form action="" method="post" id="formulario2">
        <fieldset style="width:65%; border-color: #000000; color: #000000; background-color: #C0C0C0;" align="left">
          ...
          <input type="text" name="int" id="int" value="0160" style="display: none;">
