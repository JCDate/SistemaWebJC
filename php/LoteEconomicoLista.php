...
mysqli_set_charset($conexion,"UTF8");
  ...
  $query = "SELECT * FROM loteeconomico ORDER BY componente ASC";
...
<html lang="en" dir="ltr">
  <head>
    ...
    <style type="text/css">
      .btnHist{
         position: absolute;
         top: 160px; /* ajusta la distancia desde la parte superior */
  ...
  <body align = "center" bgcolor='#AED6F1'>
    ...
    <br><div>
      <form class="btnHist" action="HistorialLoteEconomico.php" method="post">
        <button class="boton_1" type="submit" name="button">Ver Historial Completo</button>
      </form>
    </div>
    <div align='center'>
