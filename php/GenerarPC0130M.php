<?php
  ...
  $queryD = "SELECT * FROM descripcion1pc WHERE componente='$componente' AND noPartesP='0130'";
  ...
  AND descripcion3pc.componente='$componente' AND descripcion3pc.noPartesP='0130' AND descripcion3pc.no= descripcion2pc.no";
  $resultD2 = $conexion -> query($queryD2);

  // Se obtiene el máximo no. de actividades que tiene el proceso
  $queryD3 = "SELECT MAX(no) AS res FROM descripcion2pc WHERE componente='$componente' AND noPartesP='0130'";
        ...
        <div class="descripcion1" align="center">
          ...
          <fieldset style="width:65%; border-color: #000000; color: #000000; background-color: #C0C0C0;" align="left">
            <legend><label>NÚM. PARTE/ PROCESO</label>
              <input type="text" name="parte10" id="parte10" value="0130" style="width : 30px;" readonly>
            </legend>
