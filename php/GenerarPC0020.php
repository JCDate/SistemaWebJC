        ...
        <div class="descripcion1" align="center">
          ...
          <fieldset style="width:65%; border-color: #000000; color: #000000; background-color: #C0C0C0;" align="left">
            ...
            <div align='center'>
              ...
              <?php
                $queryT = "SELECT totalProceso FROM iniciopc WHERE totalProceso ='0020' AND componente='$componente'";
                $queryT2 = "SELECT totalProceso FROM iniciopc WHERE totalProceso ='0010' AND componente='$componente'";
                ...
                if ($resultT -> num_rows > 0) { ?>
                  ...
                  <button id="boton-siguiente" type="button" class="boton_1" onclick="this.form.action='GenerarPC0030.php';"><img src="/produccion/img/guardar.png" width="20" height="20" />SIGUIENTE</button>
              <?php } ?>
            </div>
          </fieldset>
        </div>
