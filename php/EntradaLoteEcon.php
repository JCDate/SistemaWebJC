...
$query = "SELECT cantAct FROM loteeconomico WHERE componente ='$componente' AND cantAct>'0'";
...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>ENTRADA LOTE ECONÓMICO</title>
  ...
  <body bgcolor="#AED6F1">
    <h3 align = "center">
      <form class="" action="guardarEntradaLoteE.php" method="post">
        <font size=5> <h1>E N T R A D A</h1>
          <br>
    ...
    <?php } ?>
            <tr>
              <td bgcolor='#89C7FA'><label>ENTRADA:</label> <input type="number"  name="entrada" id="entrada" style="font-family: Arial; font-size: 14pt; width : 150px" required><br><br></td>
              <td bgcolor='#89C7FA'><label>FECHA:</label><input type="date"  name="fechaEnt" id="fechaEnt" style="font-family: Arial; font-size: 14pt;" required><br><br></td>
            </tr>
            <tr>
              <td bgcolor='#89C7FA' colspan='2'><label>VERIFICADO POR:</label>
                  <select class="opera" name="veryEnt" id="veryEnt" style="font-family: Arial; font-size: 14pt;">
                    <option value="">--------------</option>
