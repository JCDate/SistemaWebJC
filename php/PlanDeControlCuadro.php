...
<html lang="en" dir="ltr">
  <head>
    ...
    <LINK REL=StyleSheet HREF="/produccion/css/diseñoPrdo.css" TYPE="text/css" MEDIA=screen>
...
<?php
 ...
 ?>
     <form  action='ExcelPlanC.php' method='post'>
         <button id="generar" class="btn btn-default" style=" background:#AED6F1;  border-color:#AED6F1; border:0;" ><img src='/produccion/img/Excel.png' class="derecha" width='125' height='125' /></button>
