...
if(isset($_POST["componente"]) AND $_POST["componente"] AND isset($_POST["cr"]) AND $_POST["cr"] AND
   isset($_POST["calibre"]) AND $_POST["calibre"]){

     $consulta = "INSERT INTO instPPTroquelado(componente,cr,calibre,fecha,operacion,maquina,operador,libs,causaR) VALUES('$componente','$cr','$calibre','$newDate','$op','$maquina','$operador','$libs','$causa')";
     ...
     echo "<center><h1>Datos Guardados<h1>";
       echo "<form action='/produccion/InstTroqueladosInt.php' method='post'>
        ...
        echo "<br>";
        echo "<form action='/produccion/php/InstTroqueladosInt.php' method='post'>
