  ...
  <head>
      ...
      <script>
       ...
       <script type="text/javascript">
           ...
           var fechaEntrada  = $(this).closest('tr').children()[4].textContent;
           var cunete  = $(this).closest('tr').children()[5].textContent;
           $("#id").val(id);
    ...
    <form id='frm' action="" method="post">
        <?php  if($result -> num_rows > 0) {?>
                ...
                <tr>
                  ...
                  <th bgcolor='#85C1E9' style=" font-size: 20pt;">ELIMINAR</th>
                </tr>
                </thead>
                <tbody>
        <?php while ($fila = $result  -> fetch_assoc()){?>
          ...
          <?php if ($fila['prioridad'] == "0" ) { ?>
                  ...
                  <td bgcolor= '#AED6F1' align='center'><button type='submit' style='background-color:#AED6F1; border-color:#AED6F1; border:0;' class='btn btn-info btn_add' onclick="this.form.action='php/ConfirmDeleteInspeccion.php';this.form.submit();"><img src='/produccion/img/cancelar.png' width='50' height='50' class='zoom'/></button></td>
          <?php }else if ($fila['prioridad'] == "1") {?>
                  ...
                  <td bgcolor= '#FC5E5E' align='center'><button type='submit' style='background-color:#AED6F1; border-color:#AED6F1; border:0;' class='btn btn-info btn_add' onclick="this.form.action='php/EditarInspeccion.php';this.form.submit();"><img src='/produccion/img/editProd.png' width='50' height='50' class='zoom'/></button></td>
                  <td bgcolor= '#FC5E5E' align='center'><button type='submit' style='background-color:#AED6F1; border-color:#AED6F1; border:0;' class='btn btn-info btn_add' onclick="this.form.action='php/ConfirmDeleteInspeccion.php';this.form.submit();"><img src='/produccion/img/cancelar.png' width='50' height='50' class='zoom'/></button></td>
          <?php }?>
                </tr>
        <?php  } ?>
               </tbody></table>
      <?php }?>
          ...
          <input type='text' name='fechaEntrada' id='fechaEntrada'  readonly  style="background-color:transparent; color:transparent; border-color:transparent; border-style:solid" >
          <input type='text' name='cuñete' id='cuñete'  readonly  style="background-color:transparent; color:transparent; border-color:transparent; border-style:solid" >
    </form>
    <style type="text/css">
    .boton {
